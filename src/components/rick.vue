    ...
    <van-form @submit="onSubmit" id="rick" ref="ruleForm">
      ...
      <div style="margin: 16px;">
        <van-row justify="space-around">
          ...
          <van-col span="6">
            <van-button block disabled type="primary" @click="makeFakeData">
              数据生成
            </van-button>
          </van-col>
        </van-row>
...
// 输出相应的请假原因
  if (randomType === "shijia") {
    ...
    console.log("事假原因：" + shijiaReasons[randomIndex]);
  } else {
    ...
    console.log("病假原因：" + bingjiaReasons[randomIndex]);
  }
...
//
// // 表单具有以下id属性值
// const form = document.getElementById('rick');
// // JSON数据
// const jsonData = {
//   "studentNumber": "111",
//   "isLeavingSchool": "是",
...
//   "leaveType": "病假",
//   "leaveNature": "因私请假",
//   "startDate": "2023-11-16 20:12",
//   "endDate": "2023-11-16 20:13",
//   "leaveDays": "0.5",
//   "leaveReason": "1",
//   "proofMaterial": "2323232343.com",
//   "phoneNumber": "15321411232",
//   "submitTime": "2023-11-16",
//   "approvalTime": "2023-11-16 20:13:23",
//   "approverName": "陈嘉靓"
// };
//
// // 遍历JSON数据并设置到表单中
